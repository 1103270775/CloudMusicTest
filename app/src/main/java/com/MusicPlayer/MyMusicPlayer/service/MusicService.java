package com.MusicPlayer.MyMusicPlayer.service;
...
import com.MusicPlayer.MyMusicPlayer.activity.MainActivity;
import com.MusicPlayer.MyMusicPlayer.help.MediaPlayerHelp;
...
//    private MediaPlayer mediaPlayer;
    ...
    public class MusicBind extends Binder {
        ...
        public int getPlayPosition(){
            return mMediaPlayerHelp.getPlayPosition();
        }
        //移动到当前点播放
        public void seekToPosition(int m){
            mMediaPlayerHelp.seekToPosition(m);
        }
        ...
        public void stopMusic() {
            ...
            System.out.println("时间节点:"+getPlayPosition());
        }
    }
